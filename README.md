...
- Assess the **transferability** of an ontology-based cost management model across construction domains (from buildings to infrastructure)
- Evaluate its **applicability** within the German public infrastructure regulatory framework
...
The research builds on the ontology-based cost management approach proposed by **Cassandro et al. (2025)** DOI:10.35490/EC3.2025.263, with a strong emphasis on:
...
- Integration of cost information across project phases and lifecycle processes
...
- Cost item datasets used in the German railway case study  
- Structured cost descriptions aligned with ontology-based concepts  
- Mappings between cost items and project lifecycle phases  
- Supporting documentation describing data structure and assumptions  
...
- The datasets refer to **standardized small-scale railway infrastructure projects**
- Data is provided **for research and validation purposes only**
...
- Validation of ontology-based cost management approaches
- Comparative studies across construction domains or national contexts
- Further research on semantic cost modeling and BIM-based cost integration

Users are encouraged to reuse the **semantic structure** rather than the numerical cost values when applying the data to different regulatory or project environments.
